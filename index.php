	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+6289) 5383303268</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Cake shop</a></h1>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			...
			<li>
				<img src="images/stollen.jpg" alt="" />
			</li>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Belia</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="beliaardianti011@gmail.com">beliaardianti011@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 895383303268</li>
					</ul>
				</div>
